	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("btn_addProduct")!=null) {
			...
			if(bo.checkIdAvailable(id_product)) {
				...
				listCategory = bo.getAllCategory();
				...
				ProductView_Servlet view = new ProductView_Servlet();
				view.showProductView(request, response);
		...
		if(request.getParameter("btn_updateProduct")!=null) {
			String id_category = request.getParameter("id_category");
			String id_product = request.getParameter("id_product");
			String name_product = request.getParameter("name_product");
			String brand = request.getParameter("brand");
